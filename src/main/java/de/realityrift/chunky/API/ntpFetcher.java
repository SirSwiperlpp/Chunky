...
{
    //Big thanks to Crasher508
    public interface Listener {
        void onTimeResponse(String rawDate, Date date, Exception ex);
    }

    public static final String DATE_FORMAT = "HH:mm";
    public static final SimpleDateFormat SIMPLE_DATE_FORMAT = new SimpleDateFormat(DATE_FORMAT, Locale.GERMANY);
